...
import { Search, FilterX, Edit2, Check, X, LogOut, Home, Building, FileText, ShoppingCart, Gavel, Package, ArrowUpDown, ArrowUp, ArrowDown, Download } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col min-w-0 ml-20 pb-12">
        ...
        <header className="bg-slate-50 border-b border-slate-300 sticky top-0 z-10 px-6 py-4 flex justify-between items-center shadow-none">
          <div className="flex items-center gap-4">
            <h1 className="text-xl font-bold text-slate-700 tracking-tight">Full Inventory</h1>
          </div>
          <div className="flex items-center gap-4">
